...
export class ShippingAddAddressPage {
  checkUrlAndTitlePage() {
    cy.verifyUrlAndTitlePage("address/shipping", "Shipping Address");
  }

  checkPathContentToShippingAddAddress() {
...
export const onShippingAddAddressPage = new ShippingAddAddressPage();
